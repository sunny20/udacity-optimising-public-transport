...
#         print(f"{Path(__file__).parents[0]}/data/cta_stations.csv")
#         print(self.raw_df["station_name"].unique())
...
#         print("before...................")
#         print(self.raw_df[self.raw_df["blue"]].shape)
#         print(self.raw_df[self.raw_df["red"]].shape)
#         print(self.raw_df[self.raw_df["green"]].shape)
        self.train_lines = [
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                if curr_time.minute == 0: weather.run(curr_time.month)
